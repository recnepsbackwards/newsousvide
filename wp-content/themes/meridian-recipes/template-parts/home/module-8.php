...
?>
	...
	<div class="module-wrapper module-8-wrapper">

		<div class="wrapper clearfix">

			<div class="module-8 col col-8">
			...
			<?php if ( is_active_sidebar( 'sidebar-m-8' ) ) : ?>
				<div class="sidebar col col-4 col-last">
					<?php dynamic_sidebar( 'sidebar-m-8' ); ?>
				</div><!-- .sidebar -->
			<?php endif; ?>

		</div><!-- .wrapper -->

	</div><!-- module-8-wrapper -->
