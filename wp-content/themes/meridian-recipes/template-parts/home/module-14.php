...
?>
	...
	<div class="module-wrapper module-14-wrapper">
		...
		<div class="carousel-wrapper">
			...
			<div class="wrapper clearfix">
				...
				<div class="module-14 clearfix no-col-spacing">
					...
					<div class="carousel" data-items="2">
						...
						<?php 
							...
							while ( $meridian_recipes_query->have_posts() ) : $meridian_recipes_query->the_post();
								...
								// column class
								$column_class = 'post-s4-center carousel-item col col-' . $post_columns . ' ';
