...
class CMB2 {
	...
	public function __construct( $meta_box, $object_id = 0 ) {
		...
		if ( empty( $meta_box['id'] ) ) {
			wp_die( esc_html__( 'Metabox configuration is required to have an ID parameter', 'meridian-recipes' ) );
		}
	...
	public function render_group_row( $field_group, $remove_disabled ) {
		...
		<div class="postbox cmb-row cmb-repeatable-grouping', $closed_class, '" data-iterator="', $field_group->index, '">';
			...
			echo '
			<div class="cmbhandle" title="' , esc_html__( 'Click to toggle', 'meridian-recipes' ), '"><br></div>
	...
	public function nonce() {
		...
		$this->generated_nonce = sanitize_html_class( 'nonce_' . 'CMB2php' . $this->cmb_id );
