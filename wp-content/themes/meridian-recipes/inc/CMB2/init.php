...
if ( ! class_exists( 'CMB2_Bootstrap_212', false ) ) {
	...
	class CMB2_Bootstrap_212 {
		...
		public function include_cmb() {
			...
			if ( ! defined( 'CMB2_DIR' ) ) {
				define( 'CMB2_DIR', trailingslashit( MERIDIAN_RECIPES_CMB2_PATH ) );
			}

			$this->l10ni18n();

			// Include helper functions
			require_once get_template_directory() . '/inc/CMB2/includes/helper-functions.php';

			// Now kick off the class autoloader
			spl_autoload_register( 'cmb2_autoload_classes' );

			// Kick the whole thing off
			require_once get_template_directory() . '/inc/CMB2/bootstrap.php';
		}
