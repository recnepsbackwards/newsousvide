...
class __TwigTemplate_f8300bb6f4958205d7056ad955d769c262d5174aaab43a4d3fee1b9c929fdb1e extends Twig_Template
{
...
<input type=\"text\" disabled=\"disabled\" value=\"\" placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" />";
    ...
    {
        return new Twig_Source("", "form/templates/blocks/text.hbs", "C:\\xampp\\htdocs\\newsousvide\\wp-content\\plugins\\mailpoet\\views\\form\\templates\\blocks\\text.hbs");
    }
}
